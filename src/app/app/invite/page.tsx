  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <h1 className="font-heading text-3xl text-white mb-2">ALPHA INVITES</h1>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <button
              ...
              disabled={generating}
              className="bg-primary text-white px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center gap-2"
            >
              {generating ? (
                <>
