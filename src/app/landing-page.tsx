        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              const slug = combatSportSlugs[sport]
              if (slug) {
                return (
                  <Link
                    key={sport}
                    href={`/partners/${slug}`}
                    className="px-6 py-3 bg-background border border-border rounded-full text-text-secondary hover:text-primary hover:border-primary transition-colors"
                  >
                    {sport}
                  </Link>
                )
